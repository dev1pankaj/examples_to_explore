...
/**
 * Provides the local service interface for LoginData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Pankaj Kathiriya
 * @see LoginDataLocalServiceUtil
...
public interface LoginDataLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoginDataLocalServiceUtil} to access the login data local service. Add custom service methods to {@link com.app.logintrack.service.impl.LoginDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
